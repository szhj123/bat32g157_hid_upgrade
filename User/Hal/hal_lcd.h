...
#define LCD_CS_HIGH()           PORT->PSETA = (1<<10)//PA10//PORT->PSETA = (1<<0)//PA00
#define LCD_CS_LOW()            PORT->PCLRA =  (1<<10)//PA10//PORT->PCLRA =  (1<<0)//PA00
#define LCD_RST_HIGH()          PORT->PSETA = (1<<2)//PA02//PORT->PSETA = (1<<1)//PA01
#define LCD_RST_LOW()           PORT->PCLRA =  (1<<2)//PA02//PORT->PCLRA =  (1<<1)//PA01
#define LCD_DC_HIGH()           PORT->PSETD = (1<<0)//PD00//PORT->PSETA = (1<<2)//PA02
#define LCD_DC_LOW()            PORT->PCLRD =  (1<<0)//PD00//PORT->PCLRA =  (1<<2)//PA02
